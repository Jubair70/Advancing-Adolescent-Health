...
urlpatterns = patterns('',
                       ...
                       url(r'^economic_empowerment_report/$', views.economic_empowerment_report,
                           name='economic_empowerment_report'),
                       ...
                       url(r'^community_orientation_list/$', views.community_orientation_list,
                           name='community_orientation_list'),
